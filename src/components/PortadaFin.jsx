               ...
               <div className="p-2 flex justify-end">
                  <div className="p-2 block basis-0 flex-grow flex-shrink md:flex-none">
                     <div className="text-xl mb-12 text-center">
                        <p className="text-white font-bold uppercase">Síguenos en:</p>
                     </div>
                     <div className="text-azul-claro text-2xl mb-12">
                        <div className="flex items-center mb-3">
                           <div className="border-2 p-[.4rem] border-azul-claro rounded-lg mr-2">
                        ...
                        <div className="flex items-center">
                           <div className="border-2 p-1 border-azul-claro rounded-lg mr-2">
                              <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" width="27" height="27" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24"><path fill="currentColor" d="M13.397 20.997v-8.196h2.765l.411-3.209h-3.176V7.548c0-.926.258-1.56 1.587-1.56h1.684V3.127A22.336 22.336 0 0 0 14.201 3c-2.444 0-4.122 1.492-4.122 4.231v2.355H7.332v3.209h2.753v8.202h3.312z"/></svg>
